...
class BamlStreamClient:
    ...
    def ExtractFunctions(
        ...
        fn: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Functions, types.Functions]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
    ...
    def ExtractRuntimes(
        ...
        fn: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.RT, types.RT]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[partial_types.RT, types.RT](
        raw,
        lambda x: coerce(partial_mdl, x),
        lambda x: coerce(mdl, x),
        self.__ctx_manager.get(),
